...
// just some types I grabbed from https://github.com/x64dbg/x64dbg/blob/development/src/dbg/ntdll/ntdll.h . I added a _RFW_ prefix to those

// NtQueryInformationProcess same as ZwQueryInformationProcess in the userland context
